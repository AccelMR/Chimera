...
Camera::extractFrustumPlanes() {
  ...
  // Left plane
  m_frustumPlanes[0] = Plane(viewProj.m03 + viewProj.m00,
                             viewProj.m13 + viewProj.m10,
                             viewProj.m23 + viewProj.m20,
                             viewProj.m33 + viewProj.m30);
  
  // Right plane
  m_frustumPlanes[1] = Plane(viewProj.m03 - viewProj.m00,
                             viewProj.m13 - viewProj.m10,
                             viewProj.m23 - viewProj.m20,
                             viewProj.m33 - viewProj.m30);
  
  // Bottom plane
  m_frustumPlanes[2] = Plane(viewProj.m03 + viewProj.m01,
                             viewProj.m13 + viewProj.m11,
                             viewProj.m23 + viewProj.m21,
                             viewProj.m33 + viewProj.m31);
  
  // Top plane
  m_frustumPlanes[3] = Plane(viewProj.m03 - viewProj.m01,
                             viewProj.m13 - viewProj.m11,
                             viewProj.m23 - viewProj.m21,
                             viewProj.m33 - viewProj.m31);
  
  // Near plane
  m_frustumPlanes[4] = Plane(viewProj.m03 + viewProj.m02,
                             viewProj.m13 + viewProj.m12,
                             viewProj.m23 + viewProj.m22,
                             viewProj.m33 + viewProj.m32);
  
  // Far plane
  m_frustumPlanes[5] = Plane(viewProj.m03 - viewProj.m02,
                             viewProj.m13 - viewProj.m12,
                             viewProj.m23 - viewProj.m22,
                             viewProj.m33 - viewProj.m32);
