...
class CH_CORE_EXPORT Transform
{
 public:
   ...
   */
  NODISCARD const Vector3& getLocalPosition() const { return m_localPosition; }
   ...
   */
  NODISCARD const Quaternion& getLocalRotation() const { return m_localRotation; }
   ...
   * @return Local scale
   */
  NODISCARD const Vector3& getLocalScale() const { return m_localScale; }
